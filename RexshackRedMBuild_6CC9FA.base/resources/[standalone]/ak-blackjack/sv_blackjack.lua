...
function payBet(playerId, money, condition)
    ...
    if condition == "lose" then
        TriggerClientEvent('RSGCore:Notify', src, 'Dealer won you lost $'..money, 'error', 5000, 'mp_lobby_textures', 'cross', 'COLOR_RED')
    elseif condition == "win" then
        TriggerClientEvent('RSGCore:Notify', src, 'You Won $'..money2, 'success', 5000,'mp_lobby_textures', 'cross', 'COLOR_WHITE')
        Player.Functions.AddMoney("cash", money2, "success")
    elseif condition == "push" then
        TriggerClientEvent('RSGCore:Notify', src, "Push! Take your Money Back", 'success', 5000, 'mp_lobby_textures', 'cross', 'COLOR_WHITE')
        Player.Functions.AddMoney("cash", money, "success")
    end
end
