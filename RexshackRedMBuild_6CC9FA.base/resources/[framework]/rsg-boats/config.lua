...
Config.boatShops = {
    lagras = {
        ...
        boats = { -- Change ONLY These Values: boatName, buyPrice, sellPrice and transferPrice
            ...
            canoe          = { boatName = "Canoe",          boatModel = "canoe",          buyPrice = 140,   sellPrice = 25,  transferPrice = 5  },
            pirogue        = { boatName = "Pirogue Canoe",  boatModel = "pirogue",        buyPrice = 150,   sellPrice = 30,  transferPrice = 5  },
            pirogue2       = { boatName = "Pirogue2 Canoe", boatModel = "pirogue2",       buyPrice = 150,   sellPrice = 30,  transferPrice = 5  },
            rowboat        = { boatName = "Rowboat",        boatModel = "rowboat",        buyPrice = 500,  sellPrice = 70,  transferPrice = 10 },
            rowboatSwamp   = { boatName = "Swamp Rowboat",  boatModel = "rowboatSwamp",   buyPrice = 500,  sellPrice = 70,  transferPrice = 10 },
            keelboat       = { boatName = "Keelboat",       boatModel = "keelboat",       buyPrice = 1500,  sellPrice = 600, transferPrice = 20 },
            boatsteam02x   = { boatName = "Steamboat",      boatModel = "boatsteam02x",   buyPrice = 2200, sellPrice = 900, transferPrice = 20 },
        },
    },
    saintdenis = {
