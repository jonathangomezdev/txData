...
RSGConfig.MaxPlayers = GetConvarInt('sv_maxclients', 60) -- Gets max players from config file, default 48
...
RSGConfig.Money = {}
RSGConfig.Money.MoneyTypes = { cash = 200, bank = 200, bloodmoney = 200 } -- type = startamount - Add or remove money types for your server (for ex. blackmoney = 0), remember once added it will not be removed from the database!
...
RSGConfig.Player.HungerRate = 3.2 -- Rate at which hunger goes down.
RSGConfig.Player.ThirstRate = 2.8 -- Rate at which thirst goes down.
...
RSGConfig.Server.Discord = "https://discord.gg/EPe8aPR4Kr" -- Discord invite link 
