...
Config.StartCredit      = 50
Config.CreditWarning    = 10 -- 5 x Config.LandTaxPerCycle amount : warning will trigger when < : example 5 x 1 = 5 so telegram will trigger on 4 hours
Config.SellBack         = 0.75 -- example: 0.5 = 50% of the buy price / 0.8 = 80% of the buy price
Config.StorageMaxWeight = 8000000
Config.StorageMaxSlots  = 50
Config.PurgeStorage     = true -- purge house inventory when the house is taken back by not paying taxes (disabled by default)
...
Config.Houses =
{
    ...
    {    -- house41
        name            = 'Dutton Ranch #41',
        houseid         = 'house41',
        houseprompt     = 'houseprompt41',
        menucoords      = vector3(-2568.696533203125, 349.3545837402344, 150.4545135498047),
        blipcoords      = vector3(-2568.696533203125, 349.3545837402344, 150.4545135498047),
        showblip        = true
    },
    {    -- house42
        name            = 'OCreaghs Run #42',
        houseid         = 'house42',
...
Config.HouseDoors =
{
    ...
    ---------------------------------------------------------------------------
   {
      ...
      name            = 'Door',
      doorid          = 1557478915,
      doorcoords = vector3(-2569.4780273438,352.962890625,150.54786682129)
   },
    ---------------------------------------------------------------------------
    {
        houseid         = 'house42',
