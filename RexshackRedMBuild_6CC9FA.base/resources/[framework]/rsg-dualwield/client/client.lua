...
RegisterNetEvent('rsg-dualwield:client:dualwield', function()
    local ped = PlayerPedId()
	local hasWeapon1 = RSGCore.Functions.HasItem('weapon_revolver_cattleman', 1)
	local hasWeapon2 = RSGCore.Functions.HasItem('weapon_revolver_cattleman_mexican', 1)
	if hasWeapon1 and hasWeapon2 then
		addWardrobeInventoryItem("CLOTHING_ITEM_M_OFFHAND_000_TINT_004", 0xF20B6B4A);
		addWardrobeInventoryItem("UPGRADE_OFFHAND_HOLSTER", 0x39E57B01);
		givePlayerWeapon("weapon_revolver_cattleman", 2);
		givePlayerWeapon("weapon_revolver_cattleman_mexican", 3);
	else
		RSGCore.Functions.Notify('1 Primary and 1 Secondary Required to DW!!', 'error')
	end
end)
...
RegisterNetEvent('rsg-dualwield:client:dualwield', function()
    local ped = PlayerPedId()
	local hasWeapon1 = RSGCore.Functions.HasItem('weapon_revolver_cattleman', 1)
	local hasWeapon2 = RSGCore.Functions.HasItem('weapon_revolver_doubleaction_gambler', 1)
	if hasWeapon1 and hasWeapon2 then
		addWardrobeInventoryItem("CLOTHING_ITEM_M_OFFHAND_000_TINT_004", 0xF20B6B4A);
		addWardrobeInventoryItem("UPGRADE_OFFHAND_HOLSTER", 0x39E57B01);
		givePlayerWeapon("weapon_revolver_cattleman", 2);
		givePlayerWeapon("weapon_revolver_doubleaction_gambler", 3);
	else
		RSGCore.Functions.Notify('1 Primary and 1 Secondary Required to DW!!', 'error')
	end
end)
...
RegisterNetEvent('rsg-dualwield:client:dualwield', function()
    local ped = PlayerPedId()
	local hasWeapon1 = RSGCore.Functions.HasItem('weapon_revolver_cattleman', 1)
	local hasWeapon2 = RSGCore.Functions.HasItem('weapon_revolver_navy_crossover', 1)
	if hasWeapon1 and hasWeapon2 then
		addWardrobeInventoryItem("CLOTHING_ITEM_M_OFFHAND_000_TINT_004", 0xF20B6B4A);
		addWardrobeInventoryItem("UPGRADE_OFFHAND_HOLSTER", 0x39E57B01);
		givePlayerWeapon("weapon_revolver_cattleman", 2);
		givePlayerWeapon("weapon_revolver_navy_crossover", 3);
	else
		RSGCore.Functions.Notify('1 Primary and 1 Secondary Required to DW!!', 'error')
	end
end)
...
RegisterNetEvent('rsg-dualwield:client:dualwield', function()
    local ped = PlayerPedId()
	local hasWeapon1 = RSGCore.Functions.HasItem('weapon_revolver_cattleman', 1)
	local hasWeapon2 = RSGCore.Functions.HasItem('weapon_pistol_m1899', 1)
	if hasWeapon1 and hasWeapon2 then
		addWardrobeInventoryItem("CLOTHING_ITEM_M_OFFHAND_000_TINT_004", 0xF20B6B4A);
		addWardrobeInventoryItem("UPGRADE_OFFHAND_HOLSTER", 0x39E57B01);
		givePlayerWeapon("weapon_revolver_cattleman", 2);
		givePlayerWeapon("weapon_pistol_m1899", 3);
	else
		RSGCore.Functions.Notify('1 Primary and 1 Secondary Required to DW!!', 'error')
	end
end)
...
RegisterNetEvent('rsg-dualwield:client:dualwield', function()
    local ped = PlayerPedId()
	local hasWeapon1 = RSGCore.Functions.HasItem('weapon_revolver_cattleman', 1)
	local hasWeapon2 = RSGCore.Functions.HasItem('weapon_shotgun_sawedoff', 1)
	if hasWeapon1 and hasWeapon2 then
		addWardrobeInventoryItem("CLOTHING_ITEM_M_OFFHAND_000_TINT_004", 0xF20B6B4A);
		addWardrobeInventoryItem("UPGRADE_OFFHAND_HOLSTER", 0x39E57B01);
		givePlayerWeapon("weapon_revolver_cattleman", 2);
		givePlayerWeapon("weapon_shotgun_sawedoff", 3);
	else
		RSGCore.Functions.Notify('1 Primary and 1 Secondary Required to DW!!', 'error')
	end
end)
...
RegisterNetEvent('rsg-dualwield:client:dualwield', function()
    local ped = PlayerPedId()
	local hasWeapon1 = RSGCore.Functions.HasItem('weapon_revolver_navy', 1)
	local hasWeapon2 = RSGCore.Functions.HasItem('weapon_revolver_cattleman_mexican', 1)
	if hasWeapon1 and hasWeapon2 then
		addWardrobeInventoryItem("CLOTHING_ITEM_M_OFFHAND_000_TINT_004", 0xF20B6B4A);
		addWardrobeInventoryItem("UPGRADE_OFFHAND_HOLSTER", 0x39E57B01);
		givePlayerWeapon("weapon_revolver_navy", 2);
		givePlayerWeapon("weapon_revolver_cattleman_mexican", 3);
	else
		RSGCore.Functions.Notify('1 Primary and 1 Secondary Required to DW!!', 'error')
	end
...
RegisterNetEvent('rsg-dualwield:client:dualwield', function()
    local ped = PlayerPedId()
	local hasWeapon1 = RSGCore.Functions.HasItem('weapon_pistol_volcanic', 1)
	local hasWeapon2 = RSGCore.Functions.HasItem('weapon_revolver_cattleman_mexican', 1)
	if hasWeapon1 and hasWeapon2 then
		addWardrobeInventoryItem("CLOTHING_ITEM_M_OFFHAND_000_TINT_004", 0xF20B6B4A);
		addWardrobeInventoryItem("UPGRADE_OFFHAND_HOLSTER", 0x39E57B01);
		givePlayerWeapon("weapon_pistol_volcanic", 2);
		givePlayerWeapon("weapon_revolver_cattleman_mexican", 3);
	else
		RSGCore.Functions.Notify('1 Primary and 1 Secondary Required to DW!!', 'error')
	end
...
RegisterNetEvent('rsg-dualwield:client:dualwield', function()
	...
	if hasWeapon1 and hasWeapon2 then
		...
		addWardrobeInventoryItem("UPGRADE_OFFHAND_HOLSTER", 0x39E57B01);
		givePlayerWeapon("weapon_pistol_volcanic", 2);
		givePlayerWeapon("weapon_pistol_volcanic_crossover", 3);
	else
		RSGCore.Functions.Notify('1 Primary and 1 Secondary Required to DW!!', 'error')
	end
end)
...
RegisterNetEvent('rsg-dualwield:client:dualwield', function()
    local ped = PlayerPedId()
	local hasWeapon1 = RSGCore.Functions.HasItem('weapon_pistol_semiauto', 1)
	local hasWeapon2 = RSGCore.Functions.HasItem('weapon_revolver_cattleman_mexican', 1)
	if hasWeapon1 and hasWeapon2 then
		addWardrobeInventoryItem("CLOTHING_ITEM_M_OFFHAND_000_TINT_004", 0xF20B6B4A);
		addWardrobeInventoryItem("UPGRADE_OFFHAND_HOLSTER", 0x39E57B01);
		givePlayerWeapon("weapon_pistol_semiauto", 2);
		givePlayerWeapon("weapon_revolver_cattleman_mexican", 3);
	else
		RSGCore.Functions.Notify('1 Primary and 1 Secondary Required to DW!!', 'error')
	end
...
RegisterNetEvent('rsg-dualwield:client:dualwield', function()
	...
	if hasWeapon1 and hasWeapon2 then
		...
		addWardrobeInventoryItem("UPGRADE_OFFHAND_HOLSTER", 0x39E57B01);
		givePlayerWeapon("weapon_pistol_semiauto", 2);
		givePlayerWeapon("weapon_pistol_semiauto_crossover", 3);
	else
		RSGCore.Functions.Notify('1 Primary and 1 Secondary Required to DW!!', 'error')
	end
end)
...
RegisterNetEvent('rsg-dualwield:client:dualwield', function()
    local ped = PlayerPedId()
	local hasWeapon1 = RSGCore.Functions.HasItem('weapon_pistol_mauser', 1)
	local hasWeapon2 = RSGCore.Functions.HasItem('weapon_revolver_cattleman_mexican', 1)
	if hasWeapon1 and hasWeapon2 then
		addWardrobeInventoryItem("CLOTHING_ITEM_M_OFFHAND_000_TINT_004", 0xF20B6B4A);
		addWardrobeInventoryItem("UPGRADE_OFFHAND_HOLSTER", 0x39E57B01);
...
RegisterNetEvent('rsg-dualwield:client:dualwield', function()
	...
	if hasWeapon1 and hasWeapon2 then
		...
		addWardrobeInventoryItem("UPGRADE_OFFHAND_HOLSTER", 0x39E57B01);
		givePlayerWeapon("weapon_pistol_mauser", 2);
		givePlayerWeapon("weapon_pistol_mauser_crossover", 3);
	else
		RSGCore.Functions.Notify('1 Primary and 1 Secondary Required to DW!!', 'error')
	end
end)
