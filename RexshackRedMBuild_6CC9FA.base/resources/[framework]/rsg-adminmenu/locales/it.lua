local Translations = {
  error = {
      ...
      ["missing_reason"] = "Devi dare una ragione!",
      ["invalid_reason_length_ban"] = "Devi dare un motivo e impostare una durata per il divieto!",
      ...
      ["not_online"] = "Questo Player non è online",
      ["no_receive_report"] = "Non stai ricevendo rapporti",
      ["failed_set_speed"] = "Non hai impostato una velocità.. (`fast` per super velove, `normal` per normale)",
