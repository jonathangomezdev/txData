...
CreateThread(function()
    exports['rsg-target']:AddTargetModel(Config.General.TrashBinModels, {
        options = {
            {
                event = 'rsg-oilsearch:server:searchTrash',
                type = 'server',
...
RegisterNetEvent('rsg-oilsearch:client:searchTrash', function(binId)
    RSGCore.Functions.Progressbar('rsg-oilsearch:searchingTrash', Lang:t("progressbar.searching"), Config.General.DurationOfSearch, false, true, { -- Name | Label | Time | useWhileDead | canCancel
        ...
        TriggerServerEvent('rsg-oilsearch:server:searchedTrash', binId)
