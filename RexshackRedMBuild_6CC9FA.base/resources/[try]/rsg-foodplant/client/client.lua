...
function goCollect()
    ...
    Wait(2300)
    TriggerServerEvent('qbr-foodplant:addHerbs')
    active = false
...
function GetClosestBush()
    ...
    if size > 0 then
        for index = 0, size - 1 do
            ...
            if (model_hash ==  85102137 or model_hash ==  -1663647438 or model_hash ==  -1953218412) and not oldBush[tostring(entity)] then
