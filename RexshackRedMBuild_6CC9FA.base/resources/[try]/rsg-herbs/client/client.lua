...
function GetClosestBush()
    ...
    if size > 0 then
        for index = 0, size - 1 do
            ...
            if (model_hash ==  -2018856497 or model_hash ==  -544356369  or model_hash ==  -2018856497  or model_hash ==  -260862401  or model_hash ==  -544356368  or model_hash ==  -1183789047) and not oldBush[tostring(entity)] then
